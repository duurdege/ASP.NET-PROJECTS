<%@ Page Title="" Language="C#" MasterPageFile="~/MaterPage.Master" AutoEventWireup="true" CodeBehind="SubjectRegister.aspx.cs" Inherits="test.SubjectRegister" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <!-- begin app-main -->
              ...
              <div class="card-header bg-primary ">
               <h3 class="card-title  text-white">Subject Registration</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->

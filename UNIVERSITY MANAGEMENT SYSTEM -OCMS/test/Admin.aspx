...
<%@ Page Title="" Language="C#" MasterPageFile="~/MaterPage.Master" AutoEventWireup="true" CodeBehind="Admin.aspx.cs" Inherits="test.Admin" %>
...
<%--                                        <asp:Button type="submit" Text="Add New Student" class="btn btn-success" style="float:Right;" runat="server"  /> </a>--%>
                         ...
                         try
                         {
                             ...
                             SqlCommand cmd = new SqlCommand("select * from AdminTB ", con);
                             ...
                             if (dr.HasRows)
                             {
                                 while (dr.Read())
                                 {
                                     ...
                                     Response.Write("<TD> <a href='UpdateAdmin.aspx?Reffno="+ dr.GetValue(0).ToString()+"'class='btn btn-success btn-xs'><i class='fa fa-edit'></i> " +
                                         "</a> <a href='DeleteAdmin.aspx?Reffno="+ dr.GetValue(0).ToString()+"'class='btn btn-warning btn-xs'><i class='fa fa-trash'></i> </a> " + "</TD>");

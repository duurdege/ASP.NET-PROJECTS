<%@ Page Title="" Language="C#" MasterPageFile="~/MaterPage.Master" AutoEventWireup="true" CodeBehind="StudentUpdate.aspx.cs" Inherits="test.StudentUpdate" %>
              ...
              <!-- form start -->
               <form id="form2" runat="server">
                ...
                <div class="card-footer">
                  <asp:Button ID="savedata" class="btn btn-success" runat="server" Text="Update" OnClick="savedata_Click" />

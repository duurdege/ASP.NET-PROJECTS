...
{
    public partial class MarksRegister : System.Web.UI.Page
    {
     ...
     VALUES      
                                    ('"
                    + CourseCode.Text + "','" + course_name + "','" + DropDownListEMPID.Text + "', '" + DropDownListStudentId.Text + "', '" + Lecturer_name.ToString() + "' ,'" + Convert.ToInt32(Midtearm.Text) + "' ,'" + Convert.ToInt32(TextBoxFINAL.Text) + "' ,'" + Convert.ToInt32(ACTIVITIES.Text) + "' ,'" + Total + "' ,'" + Student_Name + "' ,'" + Student_Class + "'  ,'" + Student_Department + "' ,'" + Student_Semester + "')", con);

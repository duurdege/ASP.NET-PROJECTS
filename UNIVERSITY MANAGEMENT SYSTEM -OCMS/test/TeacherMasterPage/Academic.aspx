...
<%@ Page Title="" Language="C#" MasterPageFile="~/TeacherMasterPage/TeacherMasterPage.Master" AutoEventWireup="true" CodeBehind="Academic.aspx.cs" Inherits="test.TeacherMasterPage.Academic" %>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="datatable-wrapper table-responsive">
                                            <table id="datatable" class="display compact table table-striped table-bordered">
                                                ...
                                                <tbody>
                                          <%
                          string T_ID = Session["EMPID"].ToString();
                         ...
                         try
                         {
                             ...
                             SqlCommand cmd = new SqlCommand("select * from Academic where EMPID ='"+T_ID+"' ", con);

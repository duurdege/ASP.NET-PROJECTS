...
<%@ Page Title="" Language="C#" MasterPageFile="~/MaterPage.Master" AutoEventWireup="true" CodeBehind="Result.aspx.cs" Inherits="test.Result" %>
                                              ...
                                              try
                                              {
                                                  ...
                                                  if (dr.HasRows)
                                                  {
                                                      while (dr.Read())
                                                      {
                                                          ...
                                                          "</a> <a href='ResultDelete.aspx?Reffno=" + dr.GetValue(0).ToString() + "'class='btn btn-warning btn-xs'><i class='fa fa-trash'></i> </a> " + "</TD>");

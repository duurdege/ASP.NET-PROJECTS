...
<%@ Page Title="" Language="C#" MasterPageFile="~/MaterPage.Master" AutoEventWireup="true" CodeBehind="Teacher.aspx.cs" Inherits="test.Teacher" %>
                         ...
                         try
                         {
                             ...
                             if (dr.HasRows)
                             {
                                 while (dr.Read())
                                 {
                                     ...
                                     Response.Write("<TD> <a href='TeacherUpdate.aspx?Reffno="+ dr.GetValue(0).ToString()+"'class='btn btn-success btn-xs'><i class='fa fa-edit'></i> " +
                                         "</a> <a href='TeacherDelete.aspx?Reffno="+ dr.GetValue(0).ToString()+"'class='btn btn-warning btn-xs'><i class='fa fa-trash'></i> </a> " + "</TD>");
